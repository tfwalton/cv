...
position: Clinical Psychology Registrar
pronouns: he/him
phone: 0466 726 957
...
tribble(
  ~Role, ~Year, ~Company, ~Where, ~Desc,
    "Provisional Psychologist and Clinical Psychology Registrar", "2/4/2024 -- Present", "Patches Australia", "Perth, Australia", c("Provided individual psychotherapy and assessment to children (6+) and adults with neurodevelopmental disorders including Autism, ADHD, and FASD, in addition to comorbid psychological disorders", "Worked as a part of a multidisciplinary team with paediatricians, occupational therapists, speech pathologists, exercise physiologists, and physiotherapists", "Role is part-time 8 hours per week"
  )
) %>%
...
tribble(
  ...
  "Clinical Psychology Trainee", "1/03/2022 -- 15/12/2022", "The Robin Winkler Clinic", "Perth, Australia", c(
    ...
    "Clinical Psychology Trainee", "15/12/2023 -- 1/4/2024", "Patches Australia", "Perth, Australia", c("Provide individual psychotherapy and assessment to children and adults with neurodevelopmental and psychological disorders ", "Placement was part-time comprising three days per week"
  )
) %>%
  detailed_entries(Role, Year, Company, Where, Desc)
```
